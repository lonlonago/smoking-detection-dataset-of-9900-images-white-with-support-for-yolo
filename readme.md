# Smoking detection dataset of 9900 images (white) with support for yolo.

# Body

Smoking Detection Dataset: 9900 Images (White
Supports Yolo
Photos are sent instantly to the cloud link， .
Ideal for learning, research, projects, with clear images and comprehensive categories.

1）Dataset Name: Smoking Detection Dataset
2) Label Information: 0-smoking
3) Number of Datasets: 9900
